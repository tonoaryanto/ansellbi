...
class Dashboard extends CI_Controller {
    ...
    public function index(){
        ...
        $data = [
            ...
            'cssadd'    => 'admin/dashboard/cssadd',
            'jsadd'     => 'admin/dashboard/jsadd',
        ];
        $this->load->view('admin/template/wrapper',$data);
    }

    public function histori_house_day($site=null)
    {
        if($site == null){
            $this->konfigurasi->cek_url();
            $data = [
                ...
                'link2'     => 'report/histori_house_day',
    ...
    public function histori_house_hour($site=null)
    {
        if($site == null){
        $this->konfigurasi->cek_url();
        $data = [
            'txthead1'     => 'Report Histori House ( HOUR )',
            'head1'     => 'Report',
            'link1'     => '#',
            'head2'     => 'Histori House (HOUR)',
            'link2'     => 'report/histori_house_day',
            'head3'     => '<b>Multi Data</b>',
            'link3'     => '#',
        ...
        if($site == 'myaxis'){
            $this->konfigurasi->cek_url();
            $data = [
                'txthead1'     => 'Report Histori House ( HOUR ) - Yaxis Ganda',
                'head1'     => 'Report',
                'link1'     => '#',
                'head2'     => '<b>Histori House (HOUR)</b>',
                'link2'     => 'report/histori_house_day',
                'head3'     => '<b>Yaxis Ganda</b>',
                'link3'     => '#',
