                        ...
                        if(str_replace(" ","",$sheetData[$j][0]) != 'EOF'){
                            if(str_replace(" ","",$sheetData[$j][0]) == 'H'){
                                if(str_replace(" ","",$sheetData[$j][3]) > $isigrowlast){
                                    if($data2[$i]['nama'] == '4096' OR $data2[$i]['nama'] == '1826' OR $data2[$i]['nama'] == '7098' OR $data2[$i]['nama'] == '7099' OR $data2[$i]['nama'] == '7100' OR $data2[$i]['nama'] == '7101' OR $data2[$i]['nama'] == '7197' OR $data2[$i]['nama'] == '7198' OR $data2[$i]['nama'] == '7199' OR $data2[$i]['nama'] == '7200' OR $data2[$i]['nama'] == '7201' OR $data2[$i]['nama'] == '7202' OR $data2[$i]['nama'] == '7203' OR $data2[$i]['nama'] == '7218'){
                                        $isivalue = number_format(((int)str_replace(" ","",$sheetData[$j][4]) / 10), 2, '.', '');
                                    }else{
...
/*
            if ($datak['keterangan'] == 'histori_alarm') {
            ...
            if ($datak['keterangan'] == 'histori_house') {
