...
class Export_excel extends CI_Controller {
    ...
    public function histori_house_day(){
        $fil1 = 'DAY_1';
    ...
    public function histori_house_hour(){
        $fil1 = 'HOUR_1';
        $fil2 = $this->input->post('value1');
        $fil3 = $this->input->post('value2');
        $id_user   = $this->session->userdata('id_user');
    ...
    public function reportmtd_histori_house_day($url){
    ...
    public function reportmtd_histori_house_hour($url){
        $fil1 = $this->input->post('value1');
        $fil2 = $this->input->post('value2')[$url];
        $fil3 = $this->input->post('value3');
        $id_user   = $this->session->userdata('id_user');
        ...
        $esqlgen  = "SELECT id,DATE_FORMAT(tanggal_value,'%d-%m-%Y') AS tanggal_value,CONCAT(LPAD(SUBSTRING_INDEX(jam_value, '-', 1), 2, '0'),':',LPAD(SUBSTRING_INDEX(SUBSTRING_INDEX(jam_value, '-', 2), '-', -1), 2, '0')) AS jam_value,grow_value,isi_value FROM `image2` ";
        $esqlgen .= "WHERE kode_perusahaan = '".$id_user."' AND kategori = '".$fil1."' ";
        $esqlnamadata = "AND nama_data = '".$fil2."'";
