...
class Egg_weight extends CI_Controller {
    ...
    public function dtdate(){
        ...
        $rhouse = $this->db->query("SELECT periode,growday,tanggal FROM eggweight WHERE ".$where." ORDER BY tanggal DESC LIMIT 30");
        $house = $rhouse->result();
    ...
    public function changetgl(){
        ...
        $house = $this->db->query("SELECT growday,tanggal FROM eggweight WHERE ".$where." ORDER BY tanggal DESC LIMIT 1")->row_array();
    ...
    public function changegrow(){
        ...
        $house = $this->db->query("SELECT periode,growday,tanggal FROM eggweight WHERE ".$where." ORDER BY tanggal DESC LIMIT 1")->row_array();
