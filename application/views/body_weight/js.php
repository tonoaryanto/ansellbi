...
function dtdate(){
  ...
  $.ajax({
    type: "POST",
    url : "<?php echo base_url('body_weight/dtdate'); ?>",
    data : data_json,
    dataType: "JSON",
    success: function(data){
      get_sess(data.sess);
...
function changetgl(dt){
  ...
  $.ajax({
      type: "POST",
      url : "<?php echo base_url('body_weight/changetgl'); ?>",
      data : data_json,
      dataType : "JSON",
...
function changegrow(dt){
  ...
  $.ajax({
      type: "POST",
      url : "<?php echo base_url('body_weight/changegrow'); ?>",
      data : data_json,
      dataType : "JSON",
      success : function(isi){
        get_sess(isi.sess);
...
function grafik(){
    ...
    var data_json = {};
      ...
      $.ajax({
      type: "POST",
      url : "<?php echo base_url('body_weight/grafik/'); ?>",
      data : data_json,
      dataType : "JSON",
      success : function(isi){
        get_sess(isi.sess);
...
function loadtabel() {
  ...
  data_json = {
    ...
    $.ajax({
      type: "POST",
      url : "<?php echo base_url('Body_weight/datatable'); ?>",
      data : data_json,
      dataType : "JSON",
      success : function(data){
        get_sess(data.sess);
        if(data.status == true){
          $('#mytable').DataTable( {
              ...
              buttons : [
                {
                      title : 'Data Body Weight',
                      extend: 'pdfHtml5',
                      orientation: 'landscape',
                      pageSize: 'A4',
                      filename: 'Data Body Weight',
                      attr:  {
                        id: 'btnpdf'
                      },
