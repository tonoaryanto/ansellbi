  ...
  <div class="col-sm-12">
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        <li class=""><a href="<?php echo base_url('body_weight/input_data');?>" class="btn btn-sm btn-success" title="Input Body Weight"><i class="fa fa-plus"></i><span class="hidden-xs">&nbsp;&nbsp;Input Body Weight</span></a></li>
        <li class="<?php if($this->uri->segment(3) == ''){ echo 'active';} ?>"><a href="<?php echo base_url('body_weight') ?>">History</a></li>
      </ul>
