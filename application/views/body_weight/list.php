    ...
    <div id="boxoption" class="box box-info">
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
           <a href="<?php echo base_url('body_weight/input_data');?>" class="btn btn-sm btn-success" title="Input Body Weight"><i class="fa fa-plus"></i><span class="hidden-xs">&nbsp;&nbsp;Input Body Weight</span></a>
        </div>
      </div>
