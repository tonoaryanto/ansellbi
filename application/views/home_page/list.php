...
<head>
	...
	<title>AJIBI - Mudah mengelola farm anda dan bisa diakses dimana pun dan kapan pun</title>
...
<body data-mobile-nav-trigger-alignment="right" data-mobile-nav-align="left" data-mobile-nav-style="classic" data-mobile-nav-shceme="gray" data-mobile-header-scheme="gray" data-mobile-nav-breakpoint="1199">
	...
	<div id="wrap">
								...
								<div class="navbar-header">
									<a class="navbar-brand pt-10 pb-10" href="index-virtus-3.html" rel="home">
										<span class="navbar-brand-inner">
											<img class="logo-sticky" src="assets/web/assets/logo-webk.png" alt="Ave WordPress Theme" style="width: 100px">
											<img class="mobile-logo-default" src="assets/web/assets/logo-webk.png" alt="Ave HTML Template" style="width: 100px">
											<img class="logo-default" src="assets/web/assets/logo-webk.png" alt="Ave HTML Template" style="width: 100px">
										</span>
									</a>
		...
		<main id="content" class="content">
						...
						<ul>
							...
							<li data-index="rs-9" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
								...
								<div class="tp-caption   tp-resizeme" id="slide-9-layer-8" data-x="['left','left','left','left']"
									...
									data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
									style="z-index: 12; white-space: nowrap; font-size: 72px; line-height: 86px; font-weight: 300; color: #242a3b; letter-spacing: 0px;font-family:Roboto;">
									Ansell Jaya Indonesia<br>Businness Intelegence. </div>
								...
								<div class="tp-caption   tp-resizeme" id="slide-9-layer-9" data-x="['left','left','left','left']"
									...
									data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
									data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
									style="z-index: 13; min-width: 582px; max-width: 582px; white-space: nowrap; font-size: 18px; line-height: 28px; font-weight: 400; color: rgba(0,0,0,0.5); letter-spacing: 0px;font-family:Roboto;">
									Mudah mengontrol farm anda
									dan bisa diakses dimana pun dan kapan pun. </div>
			...
			<section id="features" class="vc_row pt-100 pb-60">
				<div class="container">
					<div class="row">
						...
						<div class="lqd-column col-md-12">
							...
							<header class="fancy-title text-center mb-6">
								...
								<h2>Mengapa menggunakan Ajibi?</h2>
							</header>
						...
						<div class="lqd-column col-md-3 col-sm-6 mb-30">
							...
							<div class="iconbox iconbox-side iconbox-circle iconbox-sm">
								...
								<div class="contents">
									...
									<p>Bisa membuka data yang sudah lama tanpa perlu khawatir data hilang</p>
								</div><!-- /.contents -->
							</div><!-- /.iconbox -->
						...
						<div class="lqd-column col-md-3 col-sm-6 mb-30">
							...
							<div class="iconbox iconbox-side iconbox-circle iconbox-sm">
								...
								<div class="contents">
									...
									<p>Dengan desain yg simple memudahkan anda dalam mengelola farm</p>
								</div><!-- /.contents -->
							</div><!-- /.iconbox -->
						...
						<div class="lqd-column col-md-3 col-sm-6 mb-30">
							...
							<div class="iconbox iconbox-side iconbox-circle iconbox-sm">
								...
								<div class="contents">
									...
									<p>Data terbarukan selalu setiap waktu.</p>
								</div><!-- /.contents -->
							</div><!-- /.iconbox -->
						...
						<div class="lqd-column col-md-3 col-sm-6 mb-30">
							...
							<div class="iconbox iconbox-side iconbox-circle iconbox-sm">
								...
								<div class="contents">
									...
									<p>Menggunakan teknologi cloud sehingga bisa diakses di semua device.</p>
								</div><!-- /.contents -->
							</div><!-- /.iconbox -->
			...
			<section id="services" class="vc_row bg-cover bg-center-bottom" style="background-image: url(assets/web/assets/demo/bg/bg-71.jpg);">
				<div class="container">
					<div class="row d-flex flex-wrap align-items-end">
						...
						<div class="lqd-column col-md-7 pl-md-6 pt-50 pb-100">

							<header class="fancy-title mb-7 pr-md-9 mr-md-5">
								<h2>Kontrol Farm anda kapan pun</h2>
								<p>Mobilitas tinggi tak perlu khawatir lagi hanya tinggal buka smartphone anda farm anda langsung terkontrol</p>
							</header>
					...
					<div class="row d-flex flex-wrap align-items-center">
						...
						<div class="lqd-column col-md-6 pl-md-6 pr-md-7">
							...
							<header class="fancy-title mb-35">
								<h2 class="mt-0 mb-4 pr-md-5">Ekspor File Ke Excel</h2>
								<p>Butuh pengolahan data farm lebih lanjut atau untuk bahan presentase anda tinggal melakukan ekspor data farm ke excel</p>
							</header>
					...
					<div class="row">
						...
						<div class="lqd-column col-md-6">
							...
							<div class="iconbox iconbox-side iconbox-circle iconbox-sm iconbox-icon-linked iconbox-heading-xs mb-50">
								...
								<div class="contents">
									<h3 class="font-weight-semibold">TERINTEGRASI</h3>
									<p>Kelola dari farm satu ke farm lainnya dalam satu tampilan dashboard tanpa perlu mobilitas tinggi bisa mengeceknya dimana pun</p>
								</div><!-- /.contents -->
							</div><!-- /.iconbox -->
							...
							<div class="iconbox iconbox-side iconbox-circle iconbox-sm iconbox-icon-linked iconbox-heading-xs mb-50">
								...
								<div class="contents">
									...
									<p>Data farm telah disajikan dalam bentuk grafik singga memudahkan dalam menganalisa data.</p>
								</div><!-- /.contents -->
							</div><!-- /.iconbox -->
							...
							<div class="iconbox iconbox-side iconbox-circle iconbox-sm iconbox-icon-linked iconbox-heading-xs mb-50">
								...
								<div class="contents">
									<h3 class="font-weight-semibold">EFISIENSI</h3>
									<p>Sebuah cara yang lebih baik untuk merencanakan jangka pendek dan panjang, menghemat waktu dan uang.</p>
								</div><!-- /.contents -->
							</div><!-- /.iconbox -->
					...
					<div class="row d-flex flex-wrap align-items-center">
						...
						<div class="lqd-column col-lg-5 col-md-6 col-xs-12">
							...
							<header class="fancy-title mb-70">
								<h2 class="text-white font-size-44">Untuk demo program silahkan isi terlebih dahulu form ini.</h2>
							</header>

							<div class="contact-form contact-form-inputs-filled contact-form-button-block font-size-14">
								<form id="senddemo" method="post" novalidate="novalidate">
									<div class="row">
										<div class="col-md-12">
											<input class="bg-white text-dark" type="text" name="nama" aria-required="true" aria-invalid="false" placeholder="Masukan Nama" required>
										</div><!-- /.col-md-12 -->
										<div class="col-md-12">
											<input class="bg-white text-dark" type="email" name="email" aria-required="true" aria-invalid="false" placeholder="Masukan Email Anda" required>
										</div><!-- /.col-md-12 -->
										<div class="col-md-12">
											<input class="bg-white text-dark" type="text" name="telepon" aria-required="true" aria-invalid="false" placeholder="Masukan nomor telepon" required>
										</div><!-- /.col-md-12 -->
				...
				<div class="container">
					<div class="row d-flex flex-wrap align-items-center">
						...
						<div class="lqd-column col-md-3 col-xs-12 text-center text-md-left mb-4 mb-md-0">
							...
							<figure>
								<img src="assets/web/assets/logo-webk.png" alt="Ansell" style="width: 100px">
							</figure>
