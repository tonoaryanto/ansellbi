<div class="row">
    <div class="col-xs-12">
        ...
        <a class="btn btn-default" href="<?php echo base_url('setting/standard_value/set/temperature'); ?>" style="border-style:dashed;border-color: #555;">
          <div class="info-box" style="background:#0000;box-shadow:none;">
            ...
            <div class="info-box-content" style="min-width:100px;">
